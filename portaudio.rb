...
class Portaudio < Formula
  ...
  def install
    ...
    ENV.append "CFLAGS", "-arch x86_64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk -mmacosx-version-min=10.8"
